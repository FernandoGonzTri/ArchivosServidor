...
if($_POST['usuario'] == '' or $_POST['password'] == '' or $_POST['tension_min'] == '' or $_POST['tension_max'] == ''  or $_POST['puls'] == ''){
    $response["error"]=true;
    $response["mensaje"]="Por favor rellene todos los campos.";
}else{
    $usuario = $_POST['usuario'];
    $password = $_POST['password'];
    $tension_min = $_POST['tension_min'];
    $tension_max = $_POST['tension_max'];
    $puls = $_POST['puls'];
   ...
   if($comprobar_user == 1){
        ...
        $queryInsert = "INSERT INTO MedidasTension (usuario, fecha, tension_min, tension_max, puls) VALUES ('$usuario', '$fecha', '$tension_min', '$tension_max', '$puls')";
        if (!mysqli_query($con, $queryInsert)) {
                ...
                $response["mensaje"]="Medida de tensión añadido correctamente.";
       }
